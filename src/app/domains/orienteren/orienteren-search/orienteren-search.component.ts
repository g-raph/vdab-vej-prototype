...
@Component({
  selector: 'app-orienteren-search',
  standalone: true,
  imports: [RouterLink, CtaBlockComponent, NgFor],
  templateUrl: './orienteren-search.component.html',
  styleUrl: './orienteren-search.component.scss'
})
export class OrienterenSearchComponent {
