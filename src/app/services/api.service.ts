  ...
  opleidingen$ = new BehaviorSubject<Result[]>([
    ...
    },
    {
      ...
      modules: [
        ...
        {
          name: 'Styling en gelegenheidskapsels',
          leervorm: 'Online leren',
          duurtijd: '100 uren',
        },
        {
          name: 'Tijdelijke en permanente omvormingen',
          leervorm: 'Stage',
          duurtijd: '100 uren',
        },
        {
      ...
      beschrijving: 'Wil je graag als kapper werken, maar mis je de nodig kennis of ervaring? Dan is deze praktische opleiding perfect voor jou. Je leert er alle technieken die een kapper nodig heeft om zijn klant de perfecte look te geven. Je leert ook hoe je met klanten communiceert. De opleiding bestaat voor een groot deel uit werkplekleren.',
      name: 'Kapper',
      filterCategorie: 'Beroepsopleidingen en specialisatie',
    ...
    },
    {
      ...
      beschrijving: 'Wil je weten wat welzijn betekent voor jou als kapper? En hoe je je welzijn op de werkvloer kan verbeteren? In deze cursus leer je hoe je welzijn wettelijk wordt beschermd, wat arbeidsveiligheid is en hoe je veilig werkt, ook tijdens een zwangerschap. Je maakt kennis met de mogelijke gezondheidsproblemen en leert hoe je die kan voorkomen. Ook hygiëne en ergonomie komen aan bod: hoe zorg je voor een hygiënische werkplek, zodat infecties zich niet kunnen verspreiden? Hoe pas je je werkomgeving en je houding aan, zodat je pijnlijke klachten voorkomt? Tot slot leer je ook hoe je milieubewust en met respect voor diversiteit werkt.',
      name: 'Welzijn in het kapsalon',
    ...
    },
    {
      ...
      toelatingsvoorwaarden: [
        'Je hebt een computer nodig om deze opleiding te volgen.',
      ],
      beschrijving: 'Is barbier jouw droomjob? In deze opleiding word je op korte termijn barbier. In 20 weken doorloop je alle facetten van het herenkappen. Je leert hoe je jouw toekomstige klanten een perfecte haarsnit geeft en hun baarden & snorren modelleert. Alle lessen zijn heel praktijkgericht. Naast oefeningen op een oefenhoofd, neem je ook eigen modellen mee naar de les.',
      name: 'Barbier',
      filterCategorie: 'Persoonlijke en professionele groei',
